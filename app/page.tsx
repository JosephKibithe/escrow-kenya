        ...
        <nav className="fixed top-0 w-full z-50 liquid-glass-nav">
          <div className="w-full px-6 md:px-16 h-24 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <span className="text-2xl font-bold tracking-tight text-white font-orbitron">AHADI</span>
            </div>
            ...
            <div className="relative z-10 flex flex-col items-start text-left">
              ...
              <h1 className="text-6xl lg:text-8xl font-black tracking-tighter mb-8 leading-[0.9] font-orbitron">
                ...
                <div className="text-transparent bg-clip-text bg-gradient-to-r from-yellow-400 via-yellow-200 to-amber-500 text-glow-yellow">
                  <TextScramble text="Code is Better." delay={1200} speed={50} />
                </div>
              </h1>
              
              <p className="text-xl md:text-2xl text-gray-400 mb-12 max-w-2xl leading-relaxed font-light">
                The escrow protocol that doesn't care about your feelings. <br/>
                <span className="text-gray-100 font-semibold">Lock funds. Deliver goods. Get paid.</span>
              </p>
            ...
            <div className="relative z-10 w-full h-[600px] flex items-center justify-center lg:justify-end">
               ...
               <div className="absolute right-0 top-1/2 -translate-y-1/2 flex flex-col gap-8 z-10 pointer-events-none select-none">
                  {[
                    ...
                    <div key={i} className="text-right backdrop-blur-sm bg-black/20 p-4 rounded-xl border border-white/5 border-r-0 rounded-r-none translate-x-4">
                      <div className="text-5xl font-black text-white mb-1 tracking-tighter font-orbitron">{stat.value}</div>
                      <div className="text-xs font-bold text-yellow-500 uppercase tracking-widest">{stat.label}</div>
                    </div>
                  ))}
               </div>
            </div>
        ...
        <section id="how-it-works" className="py-24 bg-[#09090B] border-y border-white/5">
          <div className="w-full px-6 md:px-16">
            <div className="text-center mb-16">
              <h2 className="text-3xl md:text-4xl font-bold mb-4 font-orbitron">The Digital Handshake</h2>
